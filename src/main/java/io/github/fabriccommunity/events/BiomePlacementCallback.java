...
public interface BiomePlacementCallback {
	 ...
	 */
	Event<BiomePlacementCallback> VANILLA_LAYERED = EventFactory.createArrayBacked(BiomePlacementCallback.class, listeners -> (biome, genX, genZ) -> {
	 ...
	 */
	Event<BiomePlacementCallback> MULTI_NOISE = EventFactory.createArrayBacked(BiomePlacementCallback.class, listeners -> (biome, genX, genZ) -> {
		Biome vanilla = biome.get();
	...
	Event<BiomePlacementCallback> THE_END = EventFactory.createArrayBacked(BiomePlacementCallback.class, listeners -> (biome, genX, genZ) -> {
		Biome vanilla = biome.get();
